window.jwplayer = function(e) {
	...
	var i, r;
	i = [n(8), n(1), n(26), n(45), n(28), n(46), n(18), n(44), n(47), n(81), n(189)], r = function(e, t, n, i, r, o, a, s, l, u, c) {
		var d = {};
	...
	var i, r;
	i = [], r = function() {
		return "7.7.1+commercial_v7-7-1.124.commercial.0b6631.jwplayer.e3ce7d.freewheel.29562d.googima.3d265d.vast.10bf30.analytics.3ea948.plugin-gapro.7e936b.plugin-related.6bf15e.plugin-sharing.8b8aae"
	}.apply(t, i), !(void 0 !== r && (e.exports = r))
}, , function(e, t, n) {
	var i, r;
		...
		var i = function(i, r) {
			...
			function s(e) {
				...
				if(!n.renderNatively(r.get("provider").name) && o) {
					var s, d;
					for(s = 0; s < o; s++) d = i[s], l(d.kind) && !w[d._id] && (p(d), t.loadFile(d, u.bind(null, d), c))
				}
				var g = h();
	...
	i = [n(67), n(169), n(1), n(166), n(167), n(31), n(174), n(72), n(71), n(2), n(95), n(3), n(41), n(6), n(4), n(202)], r = function(e, t, n, i, r, o, a, s, l, u, c, d, p, h, f, g) {
		...
		return w.prototype = {
			...
			setup: function(o, d) {
				...
				function X(e) {
					n.isBoolean(e) || (e = !ne.get("fullscreen")), ne.set("fullscreen", e),
	...
	i = [n(25), n(71), n(19), n(27), n(1), n(2), n(4)], r = function(e, t, i, r, o, a, s) {
		...
		function g(e, n) {
			...
			}), _.on(s.JWPLAYER_ERROR, o.partial(v, e)), _.load(i)) : e()
		}
	...
	var i, r;
	i = [n(17), n(52), n(183), n(1)], r = function(e, t, i, r) {
		function o(e) {
		...
		var y = e.style,
			...
			k = function(k, x) {
				...
				function G() {
					...
					var o = x.get("height");
					b && ("string" == typeof o || o >= 1.5 * Ye) ? e.addClass(ge, "jw-flag-touch") : (Re = new h, Re.setup(x, ge, ge)), be = new d(k, x), be.on(t.JWPLAYER_USER_ACTION, ie), x.on("change:scrubbing", he), Ce = new g(x, k, be.elements.next), Ce.setup(),
						me.appendChild(Ce.element()), me.appendChild(be.element()), ge.addEventListener("focus", I), ge.addEventListener("blur", T), ge.addEventListener("keydown", C), ge.onmousedown = R, ge.onmouseup = P
				}
				...
				var ge, me, ve, we, ye, je, be, Ee, ke, xe, Ae, _e, Le, Ce, Te, Pe, Re, Ie, Me, Se, Oe, De = -1,
					Ne = b ? 4e3 : 2e3,
					Ye = 40,
					We = !1,
					Fe = !1,
				...
				y(ge, {
					...
					Le = new f(x), Le.setup(i), G(), ie(), x.set("mediaContainer", ve), x.mediaController.on("fullscreenchange", ee);
